...
class Database
{
    ...
    private static function initializeSchema(): void
    {
        ...
        if (!$settings) {
            self::insert('settings', ['key' => 'hero_label', 'value' => 'Established Excellence']);
            self::insert('settings', ['key' => 'hero_title', 'value' => 'Your Trusted Partner in <span class="text-vibrant-amber">HVAC & Wellness</span>']);
            self::insert('settings', ['key' => 'hero_subtitle', 'value' => 'Bridging industrial precision with organic vitality. We provide state-of-the-art climate solutions and premium health consumables for a balanced lifestyle.']);
            self::insert('settings', ['key' => 'hero_btn_1_text', 'value' => 'Explore Industrial']);
            self::insert('settings', ['key' => 'hero_btn_1_link', 'value' => '/products']);
        ...
        if (!$cat) {
            self::insert('categories', ['name' => 'HVAC Systems', 'slug' => 'hvac-systems', 'description' => 'Industrial HVAC equipment and components']);
            self::insert('categories', ['name' => 'HVAC Parts', 'slug' => 'hvac-parts', 'description' => 'Replacement parts and accessories']);
            self::insert('categories', ['name' => 'Wellness Supplements', 'slug' => 'wellness-supplements', 'description' => 'Organic health supplements and superfoods']);
            self::insert('categories', ['name' => 'Spices & Herbs', 'slug' => 'spices-herbs', 'description' => 'Premium organic spices and herbs']);
        }
    }
